...
@interface BTKTextField () <UITextFieldDelegate>
@property (nonatomic, copy) NSString *previousText;
@end

@implementation BTKTextField
...
- (void)setPlaceholder:(NSString *)placeholder {
    ...
    [mutablePlaceholder addAttributes:@{NSForegroundColorAttributeName: [BTKAppearance sharedInstance].placeholderTextColor, NSFontAttributeName:[UIFont fontWithName:[BTKAppearance sharedInstance].fontFamily size:[UIFont labelFontSize]]} range:NSMakeRange(0, [mutablePlaceholder length])];
...
- (void)iOS9_changed {
    ...
    if ([self.editDelegate respondsToSelector:@selector(textField:willInsertText:)]) {
        // Sets _backspace = NO; in the BTKFormField or BTKFormField subclass
