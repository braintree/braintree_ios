#import "BTKPayPalWordmarkCompactVectorArtView.h"
#import "BTKAppearance.h"

@interface BTKPayPalWordmarkCompactVectorArtView ()
@property (nonatomic, assign) BOOL includePadding;
@end

@implementation BTKPayPalWordmarkCompactVectorArtView
...
- (void)drawArt
{
    if (self.includePadding) {
        //// Color Declarations
        UIColor* payColor = [BTKAppearance payBlue]; //[UIColor colorWithRed: 0.005 green: 0.123 blue: 0.454 alpha: 1];
        UIColor* palColor = [BTKAppearance palBlue]; //[UIColor colorWithRed: 0.066 green: 0.536 blue: 0.839 alpha: 1];
        ...
        //// Color Declarations
        UIColor* color0 = [BTKAppearance palBlue];
        UIColor* color1 = [BTKAppearance payBlue];
