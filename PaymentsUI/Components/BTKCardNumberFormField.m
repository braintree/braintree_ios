...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self.validateButton setTitleColor:self.tintColor forState:UIControlStateNormal];
        [self.validateButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
        [self.validateButton sizeToFit];
        [self.validateButton layoutIfNeeded];
        //Todo do we need this width layout?
        //[self.validateButton.widthAnchor constraintEqualToConstant:self.validateButton.titleLabel.frame.size.width].active = YES;
