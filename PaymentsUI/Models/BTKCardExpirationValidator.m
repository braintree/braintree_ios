...
@implementation BTKCardExpirationValidator
...
+ (BOOL)month:(NSUInteger)month year:(NSUInteger)year validForDate:(NSDate *)date {
    ...
    NSDate *farFuture = [date dateByAddingTimeInterval:3600 * 24 * 365.25 * kBTKCardExpirationValidatorFarFutureYears]; // roughly years in the future
