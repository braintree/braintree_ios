...
- (SecKeyRef)addPeerPublicKey:(NSString *)peerName keyBits:(NSData *)publicKey {
  [self removePeerPublicKey:peerName];
	...
	LOGGING_FACILITY1( sanityCheck == noErr, @"Problem adding the public key, OSStatus == %d.", (int)sanityCheck );
...
- (void)removePeerPublicKey:(NSString *)peerName {
	...
	LOGGING_FACILITY1( sanityCheck == noErr || sanityCheck == errSecItemNotFound, @"Problem deleting the peer public key from keychain, OSStatus == %d.", (int)sanityCheck );
}
