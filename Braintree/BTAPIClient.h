...
/// and the given path.
- (void)GET:(NSString *)path parameters:(NSDictionary *)parameters completion:(void(^)(BTJSON *body, NSHTTPURLResponse *response, NSError *error))completionBlock;

/// Perfom an HTTP POST on a URL composed of the configured from environment
/// and the given path.
- (void)POST:(NSString *)path parameters:(NSDictionary *)parameters completion:(void(^)(BTJSON *body, NSHTTPURLResponse *response, NSError *error))completionBlock;
