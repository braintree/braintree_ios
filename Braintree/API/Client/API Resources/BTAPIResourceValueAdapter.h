...
- (instancetype)initWithValidator:(BOOL (^)(id rawValue))validatorBlock transformer:(id (^)(id rawValue, NSError * __autoreleasing *error))transformerBlock setter:(BOOL (^)(id model, id value, NSError *__autoreleasing*error))setterBlock NS_DESIGNATED_INITIALIZER;
