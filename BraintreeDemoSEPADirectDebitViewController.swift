...
class BraintreeDemoSEPADirectDebitViewController: BraintreeDemoBaseViewController {
    private let sepaDebitClient: BTSEPADirectDebitClient
    ...
    override init?(authorization: String!) {
        ...
        sepaDebitClient = BTSEPADirectDebitClient(apiClient: apiClient)
        ...
        sepaDebitButton.addTarget(self, action: #selector(sepaDirectDebitButtonTapped), for: .touchUpInside)
    ...
    @objc func sepaDirectDebitButtonTapped() {
        ...
        let sepaDebitRequest = BTSEPADirectDebitRequest(
        ...
        sepaDebitClient.tokenize(request: sepaDebitRequest, context: self) { sepaDebitNonce, error in
            ...
            if let sepaDebitNonce = sepaDebitNonce {
                let sepaDebitNonce = sepaDebitNonce as BTPaymentMethodNonce
