...
class BTAPIPinnedCertificates {
    ...
    static func trustedCertificates() -> [NSData] {
        ...
        result.append(NSData(bytes: dataArray2_1, length: dataArray2_1.count))
        ...
        result.append(NSData(bytes: dataArray3_1, length: dataArray3_1.count))
        ...
        // VeriSign Class 3 Public Primary Certification Authority - G2.crt
        ...
        // VeriSign Class 3 Public Primary Certification Authority - G4.crt
