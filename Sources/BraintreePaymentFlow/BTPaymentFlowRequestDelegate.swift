...
public protocol BTPaymentFlowRequestDelegate {

    /// :nodoc: Handle payment request for a variety of web/app switch flows.
    ///
    /// Use the delegate to handle success/error/cancel flows.
    func handle(_ request: BTPaymentFlowRequest, client apiClient: BTAPIClient, paymentClientDelegate delegate: BTPaymentFlowClientDelegate)
