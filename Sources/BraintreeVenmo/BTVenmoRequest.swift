...
@objcMembers public class BTVenmoRequest: NSObject {
    ...
    ///   - riskCorrelationID: Optional: A unique identifier that is used to correlate risk information for this payment. This ID should be generated by the merchant and must be unique for each payment attempt.
