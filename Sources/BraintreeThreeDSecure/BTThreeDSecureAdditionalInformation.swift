...
@objcMembers public class BTThreeDSecureAdditionalInformation: NSObject {
    ...
    var accountAgeIndicator: String?
    ...
    /// - 03: 30-60 days
    /// - 04: More than 60 days
    var accountChangeIndicator: String?
    ...
    var accountPwdChangeIndicator: String?

    /// Optional. Number of add card attempts in the last 24 hours.
    var addCardAttempts: String?
    ...
    var authenticationIndicator: String?
    ...
    ///  - 04: 30-60 days
    ///  - 05: More than 60 days
    var paymentAccountIndicator: String?
    ...
    var shippingAddress: BTThreeDSecurePostalAddress?
    ...
    var shippingAddressUsageDate: String?
    ...
    /// - 03: 30-60 days
    /// - 04: More than 60 days
    var shippingAddressUsageIndicator: String?
    ...
    /// - 07: Other
    var shippingMethodIndicator: String?
    ...
    var shippingNameIndicator: String?
