...
/// Protocol for receiving payment lifecycle messages from a Braintree object
...
- (void)braintreeWillPerformAppSwitch:(id)sender;
...
- (void)braintree:(id)sender didPerformAppSwitchToTarget:(BTAppSwitchTarget)target;
...
///
/// @param driver The payment driver
- (void)braintreeWillProcessPaymentInfo:(id)sender;
...
- (void)braintree:(id)sender requestsPresentationOfViewController:(UIViewController *)viewController;
...
- (void)braintree:(id)sender requestsDismissalOfViewController:(UIViewController *)viewController;
