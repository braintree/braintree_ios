...
- (void)registerType:(NSString *)type withTokenizationBlock:(void(^)(BTAPIClient *apiClient, NSDictionary * _Nullable options, void(^)(id <BTPaymentMethodNonce> _Nullable tokenization, NSError * _Nullable error)))tokenizationBlock;
...
- (void)tokenizeType:(NSString *)type
       withAPIClient:(BTAPIClient *)apiClient
          completion:(void(^)(id<BTPaymentMethodNonce> _Nullable tokenization, NSError * _Nullable error))completion;
