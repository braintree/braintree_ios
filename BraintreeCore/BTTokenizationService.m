...
///
/// `void (^)(BTAPIClient * _Nonnull, NSDictionary * _Nullable, void (^ _Nonnull)(id<BTPaymentMethodNonce> _Nullable, NSError * _Nullable))`
...
- (void)registerType:(NSString *)type withTokenizationBlock:(void (^)(BTAPIClient * _Nonnull, NSDictionary * _Nullable, void (^ _Nonnull)(id<BTPaymentMethodNonce> _Nullable, NSError * _Nullable)))tokenizationBlock
{
...
- (void)tokenizeType:(NSString *)type
       withAPIClient:(BTAPIClient *)apiClient
          completion:(void (^)(id<BTPaymentMethodNonce> _Nullable, NSError * _Nullable))completion
{
...
- (void)tokenizeType:(NSString *)type
       ...
       withAPIClient:(BTAPIClient *)apiClient
          completion:(void (^)(id<BTPaymentMethodNonce> _Nullable, NSError * _Nullable))completion
{
    void(^block)(BTAPIClient *, NSDictionary *, void(^)(id<BTPaymentMethodNonce>, NSError *)) = self.tokenizationBlocks[type];
    if (block) {
