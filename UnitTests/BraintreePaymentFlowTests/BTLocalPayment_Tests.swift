...
class BTLocalPayment_UnitTests: XCTestCase {
    ...
    func testStartPayment_returnsErrorWhenReturnURLInvalid() {
        ...
        client.startPaymentFlow(localPaymentRequest) { (result, error) in
            ...
            XCTAssertEqual(error.code, BTPaymentFlowErrorType.invalidReturnURL.rawValue)
            expectation.fulfill()
        }
    ...
    func testStartPayment_successfulResult_callsCompletionBlock() {
        ...
        BTPaymentFlowClient.handleReturn(URL(string: "com.braintreepayments.demo.payments://x-callback-url/braintree/local-payment/success?PayerID=PCKXQCZ6J3YXU&paymentId=PAY-79C90584AX7152104LNY4OCY&token=EC-0A351828G20802249")!)
    ...
    func testStartPayment_cancelResult_callsCompletionBlock() {
        ...
        paymentFinishedExpectation = self.expectation(description: "Payment finished expectation")
        BTPaymentFlowClient.handleReturn(URL(string: "com.braintreepayments.demo.payments://x-callback-url/braintree/local-payment/cancel?paymentId=PAY-79C90584AX7152104LNY4OCY")!)
    ...
    func testOpenURL_whenNetworkConnectionLost_sendsAnalytics() {
        ...
        BTPaymentFlowClient.handleReturn(URL(string: "an-error-url")!)
