...
- (void)testRegisterType_addsTypeToTypes {
    [service registerType:@"MyType" withTokenizationBlock:^(__unused BTAPIClient *apiClient, __unused NSDictionary *options, __unused void (^completionBlock)(id<BTPaymentMethodNonce> tokenization, NSError *error)) {
    }];
...
- (void)testTokenizeType_whenTypeIsRegistered_callsTokenizationBlock {
    ...
    [service tokenizeType:@"MyType" withAPIClient:[[BTAPIClient alloc] initWithAuthorization:@"test_key"] completion:^(__unused id<BTPaymentMethodNonce>  _Nonnull tokenization, __unused NSError * _Nonnull error) {
    }];
...
- (void)testTokenizeType_whenTypeIsNotRegistered_returnsError {
    ...
    [service tokenizeType:@"TypeThatHasntBeenRegistered" withAPIClient:[[BTAPIClient alloc] initWithAuthorization:@"test_key"] completion:^(id<BTPaymentMethodNonce>  _Nonnull tokenization, NSError * _Nonnull error) {
