...
class BTVenmoClient_Tests: XCTestCase {
    ...
    func testTokenizeVenmoAccount_whenReturnURLContainsPaymentContextID_getsResultFromPaymentContext() {
        ...
        BTVenmoClient.handleReturn(URL(string: "scheme://x-callback-url/vzero/auth/venmo/success?resource_id=12345")!)
    ...
    func testTokenizeVenmoAccount_whenUsingTokenizationKeyAndAppSwitchSucceeds_tokenizesVenmoAccount() {
        ...
        BTVenmoClient.handleReturn(URL(string: "scheme://x-callback-url/vzero/auth/venmo/success?paymentMethodNonce=fake-nonce&username=fake-username")!)
    ...
    func testTokenizeVenmoAccount_whenAppSwitchFails_callsBackWithError() {
        ...
        BTVenmoClient.handleReturn(URL(string: "scheme://x-callback-url/vzero/auth/venmo/error")!)
    ...
    func testTokenizeVenmoAccount_whenAppSwitchCanceled_callsBackWithNoError() {
        ...
        BTVenmoClient.handleReturn(URL(string: "scheme://x-callback-url/vzero/auth/venmo/cancel")!)
    ...
    func testCanHandleReturnURL_withValidHost_andValidPath_returnsTrue() {
        ...
        XCTAssertTrue(BTVenmoClient.canHandleReturn(URL(string: "fake-scheme://\(host)\(path)fake-result")!))
    }

    func testCanHandleReturnURL_withInvalidHost_andValidPath_returnsFalse() {
        let host = "bad-host"
        let path = "/vzero/auth/venmo/"
        XCTAssertFalse(BTVenmoClient.canHandleReturn(URL(string: "fake-scheme://\(host)\(path)fake-result")!))
    }
    ...
    func testCanHandleReturnURL_withNoHost_andNoPath_returnsFalse() {
        XCTAssertFalse(BTVenmoClient.canHandleReturn(URL(string: "fake-scheme://")!))
    }
    ...
    func testAuthorizeAccountWithTokenizationKey_vaultTrue_willNotAttemptToVault() {
        ...
        BTVenmoClient.handleReturn(URL(string: "scheme://x-callback-url/vzero/auth/venmo/success?paymentMethodNonce=lmnop-venmo-nonce&username=venmotim")!)
        self.waitForExpectations(timeout: 2, handler: nil)
