...
class BTThreeDSecureAuthenticateJWT_Tests: XCTestCase {
    ...
    override func setUp() {
        ...
        let paymentMethodNonce = BTCardNonce.init(nonce: "fake-nonce-to-test", localizedDescription: nil)
    ...
    func testThreeDSecureAuthenticateJWT_FailsWithErrorDescription() {
