...
//}
//
//- (void)fetchOrReturnRemoteConfiguration:(nonnull void (^)(BTConfiguration *, NSError *))completionBlock {
//    BTConfiguration *configuration = [[BTConfiguration alloc] initWithJSON:self.cannedConfigurationResponseBody];
//    completionBlock(configuration, self.cannedConfigurationResponseError);
//}
//
//
//
