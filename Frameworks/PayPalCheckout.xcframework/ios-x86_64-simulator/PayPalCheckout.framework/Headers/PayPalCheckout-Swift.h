...
/// Attempting to call this function during an active session will result in
...
///   </li>
///   <li>
///     experience: one of the predefined experiences
///   </li>
///   <li>
...
typedef SWIFT_ENUM_NAMED(NSInteger, PPCUserAction, "UserAction", open) {
  PPCUserActionContinue = 0,
  PPCUserActionPayNow = 1,
};
