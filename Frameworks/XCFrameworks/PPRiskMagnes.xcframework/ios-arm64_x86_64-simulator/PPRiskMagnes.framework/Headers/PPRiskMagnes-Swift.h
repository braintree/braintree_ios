...
enum MagnesSubmitStatus : NSInteger;
@class UITextField;
@class UITouch;
@class UIEvent;
...
/// Collect Magnes data and submit to PayPal Risk with submitStatus callback
/// <ul>
///   <li>
///     Parameters:
///   </li>
///   <li>
///     onSubmitComplete: Callback that returns isSuccess - Payload successfuly submited and debug Id of submission call
///   </li>
/// </ul>
///
/// returns:
/// MagnesResult
- (MagnesResult * _Nonnull)collectAndSubmitOnSubmitComplete:(void (^ _Nonnull)(enum MagnesSubmitStatus, NSString * _Nullable))onSubmitComplete SWIFT_WARN_UNUSED_RESULT;
/// Collect Magnes data and submit to PayPal Risk
...
/// \param additionalData additional key value pairs: [String: String]
///
/// \param onSubmitComplete Callback that returns isSuccess - Payload successfuly submited and debug Id of submission call
///
///
/// throws:
/// <code>cmidErrorMessage</code> if <code>cmid</code> length is more than 32
...
/// returns:
/// MagnesResult
- (MagnesResult * _Nullable)collectAndSubmitWithPayPalClientMetadataId:(NSString * _Nonnull)cmid withAdditionalData:(NSDictionary<NSString *, NSString *> * _Nonnull)additionalData error:(NSError * _Nullable * _Nullable)error onSubmitComplete:(void (^ _Nonnull)(enum MagnesSubmitStatus, NSString * _Nullable))onSubmitComplete SWIFT_WARN_UNUSED_RESULT;
...
/// Status enum for API submission results
typedef SWIFT_ENUM(NSInteger, MagnesSubmitStatus, open) {
  MagnesSubmitStatusSuccess = 0,
  MagnesSubmitStatusError = 1,
  MagnesSubmitStatusTimeout = 2,
};
